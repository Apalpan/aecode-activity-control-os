...
- Prompt operativo pegado el 2026-06-05 sobre persistencia local, store backend-ready, import/export, seguridad y privacidad: se uso la parte de producto y arquitectura. No se aplico anonimato total porque el tablero interno debe mostrar nombres reales por instruccion de Alejandro.
